...
# Production error monitoring (Sentry). Dormant unless SENTRY_DSN is set, so dev
# and test never phone home — see config/initializers/sentry.rb.
gem "sentry-ruby"
gem "sentry-rails"
...
group :development, :test do
  ...
  # Loads .env locally so secrets (ADMIN_EMAIL, etc.) work without exporting them.
  gem "dotenv-rails"
...
gem "selenium-webdriver", "~> 4.47", group: :test
